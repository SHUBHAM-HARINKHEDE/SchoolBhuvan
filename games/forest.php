...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
	...
	<body>
			...
			<div class="container">
				<br /><br /><br />
				<div class="panel">
					<h1>&nbsp Type of Forest in India</h1>
					<hr />
					<div id="flashContent">
						<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" width="1100" height="670" id="forest" align="middle">
							<param name="movie" value="forest.swf" />
							...
							<!--[if !IE]>-->
							<object type="application/x-shockwave-flash" data="forest.swf" width="1100" height="670">
								<param name="movie" value="forest.swf" />
								<param name="quality" value="high" />
								<param name="bgcolor" value="#ffffff" />
								<param name="play" value="true" />
